...
<body>
    ...
    <tr><td>
			...
			$count=mysql_num_rows($result);
			if($count>=1){
			echo "<table onMouseover=\"changeto(event, 'lightblue')\" onMouseout=\"changeback(event, 'white')\"  align='center' width='400' border='0'>";
			echo "<tr id=\"ignore\"><td><b>DÍA</b></td><td><b>HORA INICIAL</b></td><td><b>HORA FINAL</b></td></tr>";	
