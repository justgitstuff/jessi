...
<body>
    ...
    <tr><td><b><font color="#000000">[ REPORTES - SALONES ]</font></b></td></tr>
    <tr height="50"><td></td></tr>
    <tr><td>
	</table>
            <?php
			$query  = "SELECT * FROM lugar WHERE Tipo='S'";
			...
			while ($row = @mysql_fetch_array($result, MYSQL_ASSOC)) {
				...
				echo"<a href='salones_grupos.php?type=mod&id=".@$row['Lugar_Id']."'>VER HORARIOS ASIGNADOS AL SALÓN</a>";
				echo "</td></tr>";
			}
			echo "</table><br />";
			} else {
			echo "<br><b>No existen salones registrados.</b>";
			}
